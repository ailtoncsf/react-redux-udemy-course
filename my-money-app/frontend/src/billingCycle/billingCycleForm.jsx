...
class BillingCycleForm extends Component {
    ...
    calculateSummary() {
        //implementando map reducer com javascript
        const sum = (t, v) => t + v
        return {
    ...
    render() {
        ...
        const { sumOfCredits, sumOfDebts } = this.props.calculateSummary()
        ...
        return (
            <form role="form" onSubmit={handleSubmit}>
                <div className="box-body">
                    ...
                    <ItemList cols='12 6' list={debts} readOnly={readOnly} field='debts' legend='Déditos' showStatus={true} />
                </div>
